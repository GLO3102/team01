...
(function(window, angular, undefined) {
  ...
  angular.module('satellizer', [])
    ...
    .factory('SatellizerStorage', ['$window', '$log', 'SatellizerConfig', '$cookies', function($window, $log, config, $cookies) {
      ...
      return {
        get: function(key) {
          return isStorageAvailable ? $cookies.getObject(key) : store[key];
        },
        set: function(key, value) {
          return isStorageAvailable ? $cookies.putObject(key, value) : store[key] = value;
        },
        remove: function(key) {
          return isStorageAvailable ? $cookies.remove(key): delete store[key];
        }
      };
